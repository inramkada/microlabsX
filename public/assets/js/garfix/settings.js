(function () {
  ...
  const COPY = {
    en: {
      ...
      autoVoiceHint: "MICROLABSX AI will use your browser voice to answer your questions.",
      hyperion: "HYPERION MOD",
      hyperionHint: "Give MICROLABSX AI permission to control this website safely.",
    ...
    es: {
      ...
      autoVoiceHint: "MICROLABSX AI utilizará la voz de tu navegador para dar respuesta a tus preguntas.",
      hyperion: "HYPERION MOD",
      hyperionHint: "MICROLABSX AI obtiene permiso para controlar esta web de forma segura.",
    ...
    ar: {
      ...
      autoVoiceHint: "سيستخدم MICROLABSX AI صوت المتصفح للرد على أسئلتك.",
      hyperion: "HYPERION MOD",
      hyperionHint: "امنح MICROLABSX AI إذناً للتحكم في هذا الموقع بأمان.",
    ...
    ca: {
      ...
      autoVoiceHint: "MICROLABSX AI utilitzarà la veu del navegador per llegir les respostes.",
      hyperion: "HYPERION MOD",
      hyperionHint: "Dona permís a MICROLABSX AI per controlar aquest lloc web de manera segura.",
    ...
    eu: {
      ...
      autoVoiceHint: "MICROLABSX AIk nabigatzailearen ahotsa erabiliko du erantzunak irakurtzeko.",
      hyperion: "HYPERION MOD",
      hyperionHint: "Eman MICROLABSX AIri webgune hau modu seguruan kontrolatzeko baimena.",
    ...
    zh: {
      ...
      compact: "紧凑",
      autoVoice: "自动朗读",
      autoVoiceHint: "MICROLABSX AI 将使用浏览器语音功能朗读回答。",
      hyperion: "HYPERION MOD",
      hyperionHint: "授权 MICROLABSX AI 安全地控制本网站。",
    ...
    hi: {
      ...
      autoVoiceHint: "MICROLABSX AI उत्तर पढ़ने के लिए आपके ब्राउज़र की आवाज़ का उपयोग करेगा।",
      hyperion: "HYPERION MOD",
      hyperionHint: "MICROLABSX AI को इस वेबसाइट को सुरक्षित रूप से नियंत्रित करने की अनुमति दें।",
    ...
    ru: {
      ...
      autoVoiceHint: "MICROLABSX AI будет использовать голос браузера для озвучивания ответов.",
      hyperion: "HYPERION MOD",
      hyperionHint: "Разрешите MICROLABSX AI безопасно управлять этим сайтом.",
    ...
    fr: {
      ...
      autoVoiceHint: "MICROLABSX AI utilisera la voix du navigateur pour lire les réponses.",
      hyperion: "HYPERION MOD",
      hyperionHint: "Autorisez MICROLABSX AI à contrôler ce site de manière sécurisée.",
    ...
    ja: {
      ...
      compact: "コンパクト",
      autoVoice: "自動読み上げ",
      autoVoiceHint: "MICROLABSX AI がブラウザの音声機能を使って回答を読み上げます。",
      hyperion: "HYPERION MOD",
      hyperionHint: "MICROLABSX AI にこのサイトを安全に操作する権限を与えます。",
  ...
  function initUI() {
    ...
    drawer.innerHTML = `
      ...
      <div class="mx-garfix-settings-brand">MICROLABSX AI <span>BY MICROSTUDIOX</span></div>
    `;
